...
3. Registration deadline is the [SOMETIME OCTOBER], 11:59 PM PDT. After the deadline, no new players or teams will be accepted into the Echo League Season 3
...
8. If there are any problems or discrepancies with the information generated at registration, it is the player’s responsibility to inform the admin team of such issues.  
    1. If it is not reported in a timely manner player may be punished under rule [I.2](https://github.com/EchoLeague/Echo-League-Rules/blob/master/RULES.md#i-registration-rules).
...
4. Your Pro-Name must match your Echo League name set at signup (sans Sponsor and Team Abbreviation).
    ...
    2. All “Team Organizers” must be registered on the community Discord server, using their official “pro name” so other players can easily identify and contact them
        ...
        2. Players can request admins/bot in Discord set a nickname that shows their proper EL Name in the community Discord
...
1. Solo players are freely able to organise and create their own teams until the October Deadline?
...
<!--Possible rule about TOs being non players, allowing rosters of up to 8 (1TO + 7 players)-->
...
2. Team Organizers do not need to be active players, and can be purely managerial
    ...
    <!--Maybe adjust this depending on above-->
3. Team Organizers can adjust their team roster during the season in the following ways:
    ...
    2. Add players to roster
        ...
        3. Added players cannot be banned from EchoLeague
        4. If a potential new player has recently left a team, they must have waited at least one (1) game week before playing with a new team in accordance with rule [II.4.1](https://github.com/EchoLeague/Echo-League-Rules/blob/master/RULES.md#ii-player-rules)
        5. Players cannot be added to a team after (S3 PLAYOFF START TIME), 11:59 PM PDT
...
1. Teams are able to use **one** stand-in for series where the team is one player short for their game, as long as they meet the following requirements:
    ...
    4. Must NOT be on transfer cooldown (LINK HERE)
